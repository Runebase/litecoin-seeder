...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Runebase-seeder\n"
...
static const string mainnet_seeds[] = {"dnsseed.runebase.io", "dnsseed.runebase.org",  ""};
static const string testnet_seeds[] = {"dnsseed-testnet.runebase.io", ""};
